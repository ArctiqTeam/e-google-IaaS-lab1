...
Open the Code Editor using the **pencil symbol** in the illustration, that can be found along right top side of the Cloud Shell.

You should now be looking at a browser windows that has the Code Editor at the top and the Shell at the bottom.
